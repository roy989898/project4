...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayJoke extends MyApiRequest<com.example.user.myapplication.backend.myApi.model.JokeTeller> {
     ...
     */
    protected SayJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.user.myapplication.backend.myApi.model.JokeTeller.class);
    }
